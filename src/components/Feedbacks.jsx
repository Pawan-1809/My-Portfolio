...
const FeedbackCard = ({ index, quote, name, image }) => {
  ...
  return (
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      <div className={`bg-tertiary rounded-2xl ${styles.padding} min-h-[300px]`}>
        <div>
          <p className={styles.sectionSubText}>Did you know?</p>
          <h2 className={styles.sectionHeadText}>Tech Quotes.</h2>
        </div>
      </div>
      <div
